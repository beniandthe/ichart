...
final class ChordInkCandidateComposerTests: XCTestCase {
    ...
    func testRecognitionComposerStillAllowsOpenLoopAttachedFlatRootAccidentalWithGRootPressureLookalike() {
        let result = recognitionComposer.composeRecognitionCandidates(
            from: [
                [glyph("C", confidence: 0.96, source: .heuristic)],
                [
                    glyph("b", confidence: 0.9996, source: .heuristic),
                    glyph("G", confidence: 0.97, source: .heuristic)
                ]
            ],
            clusters: [
                cluster(minX: 0, minY: 20, maxX: 24, maxY: 60),
                openLoopFlatLikeCluster(minX: 41, minY: 26, maxX: 55, maxY: 54)
            ]
        )
        let displayTexts = result.candidates.compactMap { candidate in
            ChordRecognitionCompendium.match(candidate.text)?.displayText
    ...
    func testRecognitionComposerStillAllowsWiderOpenLoopAttachedFlatRootAccidental() {
        let result = recognitionComposer.composeRecognitionCandidates(
            from: [
                [glyph("C", confidence: 0.96, source: .heuristic)],
                [
    ...
    func testRecognitionComposerStillAllowsShallowAngleStemReturnFlatRootAccidental() {
        let result = recognitionComposer.composeRecognitionCandidates(
            from: [
                [glyph("C", confidence: 0.96, source: .heuristic)],
                [
    ...
    func testRecognitionComposerRejectsOversizedOpenLoopDetachedGRootAsFlatAccidental() {
        let result = recognitionComposer.composeRecognitionCandidates(
            from: [
                [glyph("C", confidence: 0.96, source: .heuristic)],
                [
                    glyph("b", confidence: 0.9996, source: .template),
                    glyph("G", confidence: 0.97, source: .heuristic)
                ]
            ],
            clusters: [
                cluster(minX: 0, minY: 20, maxX: 24, maxY: 60),
                widerOpenLoopFlatLikeCluster(minX: 41, minY: 23, maxX: 64, maxY: 53)
            ]
        )
        let displayTexts = result.candidates.compactMap { candidate in
            ChordRecognitionCompendium.match(candidate.text)?.displayText
    ...
    func testRecognitionComposerRejectsCurvedDetachedGRootAsFlatAccidental() {
        let result = recognitionComposer.composeRecognitionCandidates(
            from: [
                [glyph("C", confidence: 0.96, source: .heuristic)],
                [
            ...
            clusters: [
                cluster(minX: 0, minY: 20, maxX: 24, maxY: 60),
                curvedDetachedGCluster(minX: 41, minY: 23, maxX: 53, maxY: 55)
            ]
        )
        let displayTexts = result.candidates.compactMap { candidate in
            ChordRecognitionCompendium.match(candidate.text)?.displayText
    ...
    private func openLoopFlatLikeCluster(
        minX: Double,
        minY: Double,
        maxX: Double,
        maxY: Double
        ...
        return InkCluster(strokes: [
            InkStroke(points: [
                InkPoint(x: minX, y: minY, timeOffset: nil),
                InkPoint(x: minX, y: minY + height * 0.25, timeOffset: nil),
                InkPoint(x: minX, y: minY + height * 0.55, timeOffset: nil),
                InkPoint(x: minX + width * 0.05, y: minY + height * 0.82, timeOffset: nil),
                InkPoint(x: minX + width * 0.35, y: maxY, timeOffset: nil),
                InkPoint(x: minX + width * 0.85, y: minY + height * 0.88, timeOffset: nil),
                InkPoint(x: maxX, y: minY + height * 0.62, timeOffset: nil),
                InkPoint(x: minX + width * 0.82, y: minY + height * 0.48, timeOffset: nil),
                InkPoint(x: minX + width * 0.58, y: minY + height * 0.42, timeOffset: nil),
                InkPoint(x: minX + width * 0.48, y: minY + height * 0.50, timeOffset: nil),
                InkPoint(x: minX + width * 0.58, y: minY + height * 0.58, timeOffset: nil),
                InkPoint(x: minX + width * 0.70, y: minY + height * 0.62, timeOffset: nil)
            ])
        ])
    }

    private func widerOpenLoopFlatLikeCluster(
        minX: Double,
        minY: Double,
        maxX: Double,
        maxY: Double
        ...
        return InkCluster(strokes: [
            InkStroke(points: [
                InkPoint(x: minX, y: minY, timeOffset: nil),
                InkPoint(x: minX, y: minY + height * 0.22, timeOffset: nil),
                InkPoint(x: minX, y: minY + height * 0.55, timeOffset: nil),
                InkPoint(x: minX + width * 0.06, y: minY + height * 0.84, timeOffset: nil),
                InkPoint(x: minX + width * 0.34, y: maxY, timeOffset: nil),
                InkPoint(x: minX + width * 0.88, y: minY + height * 0.86, timeOffset: nil),
                InkPoint(x: maxX, y: minY + height * 0.62, timeOffset: nil),
                InkPoint(x: minX + width * 0.80, y: minY + height * 0.48, timeOffset: nil),
                InkPoint(x: minX + width * 0.56, y: minY + height * 0.42, timeOffset: nil),
    ...
    private func wideStemReturnFlatLikeCluster(
        ...
        maxX: Double,
        maxY: Double,
        endXRatio: Double = 0.28,
        endYRatio: Double = 0.54
    ) -> InkCluster {
        let height = maxY - minY
        let width = maxX - minX
        return InkCluster(strokes: [
            InkStroke(points: [
                ...
                InkPoint(x: minX + width * endXRatio, y: minY + height * endYRatio, timeOffset: nil)
            ])
        ])
    }

    private func curvedDetachedGCluster(
        minX: Double,
        minY: Double,
        maxX: Double,
        maxY: Double
        ...
        return InkCluster(strokes: [
            InkStroke(points: [
                InkPoint(x: maxX - width * 0.08, y: minY, timeOffset: nil),
                InkPoint(x: minX + width * 0.42, y: minY + height * 0.19, timeOffset: nil),
                InkPoint(x: minX + width * 0.08, y: minY + height * 0.47, timeOffset: nil),
                InkPoint(x: minX, y: minY + height * 0.81, timeOffset: nil),
                InkPoint(x: minX + width * 0.50, y: maxY, timeOffset: nil),
                InkPoint(x: maxX, y: minY + height * 0.84, timeOffset: nil),
                InkPoint(x: minX + width * 0.67, y: minY + height * 0.66, timeOffset: nil),
                InkPoint(x: minX + width * 0.33, y: minY + height * 0.63, timeOffset: nil),
                InkPoint(x: minX + width * 0.75, y: minY + height * 0.56, timeOffset: nil)
            ])
        ])
    }
