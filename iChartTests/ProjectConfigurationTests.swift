...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testHelpSurfaceIncludesTutorialWalkthrough() throws {
        ...
        XCTAssertTrue(libraryText.contains("Use Chord only when iChart should read handwritten chord entry"))
        XCTAssertTrue(libraryText.contains("Use Free-Write as persistent page ink for free writing chords, rhythms, articulations, notes, and cues."))
        XCTAssertTrue(libraryText.contains("Tap Done in an active tool before switching tools."))
        XCTAssertTrue(libraryText.contains("Free-Write does not create movable boxes."))
        ...
        XCTAssertTrue(libraryText.contains("The top row contains Page, Select, Measures, Repeats, Coda, Text, Time, Rhythm when available, Chord, and Free-Write."))
        XCTAssertTrue(libraryText.contains("On the first measure, Delete first clears a double or final right barline while keeping the opening barline intact."))
    ...
    func testSupabasePackageAndConfigurationAreWired() throws {
        ...
        XCTAssertTrue(projectText.contains("CURRENT_PROJECT_VERSION: \"26\""))
