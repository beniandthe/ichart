...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testFirstRunAccountLandingIsMandatoryAndCollectsName() throws {
        ...
        XCTAssertTrue(libraryText.contains("IChartAccountScopedScribbleTextField"))
        XCTAssertTrue(libraryText.contains("IChartAccountScopedScribbleUITextField: UITextField, UIScribbleInteractionDelegate"))
        XCTAssertTrue(libraryText.contains("func scribbleInteraction("))
        XCTAssertTrue(libraryText.contains("allowsScribble && bounds.contains(location)"))
        XCTAssertFalse(libraryText.contains("TextField(placeholder, text: $text)"))
        XCTAssertFalse(libraryText.contains("SecureField(placeholder, text: $text)"))
    ...
    func testSupabasePackageAndConfigurationAreWired() throws {
        ...
        XCTAssertTrue(projectText.contains("CURRENT_PROJECT_VERSION: \"34\""))
