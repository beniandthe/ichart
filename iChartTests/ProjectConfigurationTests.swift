...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testHostedSupportSiteRoutesToRealContactPath() throws {
        ...
        XCTAssertTrue(htaccessText.contains("RewriteRule ^support/$ /support.html [R=301,L]"))
        XCTAssertTrue(htaccessText.contains("RewriteRule ^support$ support.html [L]"))
        XCTAssertTrue(htaccessText.contains("RewriteRule ^privacy/$ /privacy.html [R=301,L]"))
        XCTAssertTrue(htaccessText.contains("RewriteRule ^privacy$ privacy.html [L]"))
        XCTAssertTrue(htaccessText.contains("RewriteRule ^terms/$ /terms.html [R=301,L]"))
    ...
    func testHelpSurfaceIncludesTutorialWalkthrough() throws {
        ...
        XCTAssertTrue(editorText.contains("Write a chord, then tap outside the writing area"))
        ...
        XCTAssertTrue(editorText.contains("Free-Write is persistent page ink for free writing chords, rhythms, articulations"))
