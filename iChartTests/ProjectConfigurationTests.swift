...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testFirstRunAccountLandingIsMandatoryAndCollectsName() throws {
        ...
        XCTAssertFalse(appRootText.contains("hasSeenAccountLandingKey"))
        XCTAssertFalse(appRootText.contains("UserDefaults.standard.bool(forKey: Self.hasSeenAccountLandingKey)"))
