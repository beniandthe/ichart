...
begin
    if (old_first_name is null or old_last_name is null)
       and (requested_first_name is null or requested_last_name is null) then
        raise exception 'first and last name are required to complete account identity'
            using errcode = '23514';
    end if;
