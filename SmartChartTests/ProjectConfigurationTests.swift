...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testHelpSurfaceIncludesTutorialWalkthrough() throws {
        ...
        XCTAssertTrue(libraryText.contains("Delete removes the selected measure. Range starts a delete range, Del Thru finishes it, and Clear cancels the pending range."))
        ...
        XCTAssertTrue(editorText.contains("Use Add, Stack, First, Double, New Sys or Join, Delete, Range, Del Thru, and Clear"))
