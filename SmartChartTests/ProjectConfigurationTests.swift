...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testHelpSurfaceIncludesTutorialWalkthrough() throws {
        ...
        XCTAssertTrue(libraryText.contains("selectedSectionID"))
        ...
        XCTAssertTrue(libraryText.contains("Page Tool"))
        XCTAssertTrue(libraryText.contains("Coda Tool"))
        XCTAssertTrue(libraryText.contains("Charts And Projects"))
        XCTAssertTrue(libraryText.contains("Editor Navigation"))
        XCTAssertTrue(libraryText.contains("Simple Chord Sheet"))
        XCTAssertTrue(libraryText.contains("Rhythm Section Sheet"))
        XCTAssertTrue(libraryText.contains("Export And Pro"))
        XCTAssertTrue(libraryText.contains("Slash count follows the top time-signature number"))
        XCTAssertTrue(libraryText.contains("Use Measures for add, stack, break, delete, width, and fill actions"))
        XCTAssertTrue(libraryText.contains("Use Repeats for repeat barlines and endings"))
        XCTAssertTrue(libraryText.contains("Use the Coda tool for Coda, To Coda, Segno, D.S., D.C., Fine, N.C."))
        ...
        XCTAssertTrue(editorText.contains("Write a chord, then tap to read it"))
        ...
        XCTAssertTrue(editorText.contains("Create single measures or stacks"))
        XCTAssertTrue(editorText.contains("move measures to new systems"))
        XCTAssertTrue(editorText.contains("Add repeat barlines and first or second endings"))
        XCTAssertTrue(editorText.contains("Add Coda, To Coda, Segno, D.S., D.C., Fine, N.C."))
        ...
        XCTAssertFalse(editorText.contains("Repeats have their own tool"))
    ...
    func testForumCommunityLibraryInfrastructureIsProOnlyAndSnapshotBased() throws {
        ...
        XCTAssertTrue(pdfPreviewText.contains("Saved to PDF Library"))
