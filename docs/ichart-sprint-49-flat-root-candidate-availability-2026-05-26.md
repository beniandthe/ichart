# iChart Sprint 49 Flat Root Candidate Availability

Status: active implementation
Date: 2026-05-26
Source of truth: `docs/ichart-sprint-source-of-truth.md`
Prior evidence: `docs/ichart-sprint-48-persistent-timing-telemetry-2026-05-26.md`
...
- `ChordEntryPassReplayTests` can target a specific saved chart with `ICHART_REPLAY_CHART_ID`, and can optionally print glyph and stroke diagnostics.
