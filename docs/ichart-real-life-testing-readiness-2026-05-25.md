# iChart Real-Life Testing Readiness

Status: Sprint 42 readiness artifact
Date: 2026-05-25
Primary authority: `docs/ichart-sprint-source-of-truth.md`
...
1. Open iChart to the Projects library.
...
Record the pass in `docs/ichart-real-pencil-field-test-log-2026-05-26.md` so the next sprint can be chosen from product evidence instead of memory.
...
- iOS simulator `iChart` scheme tests must pass
