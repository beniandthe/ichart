# iChart Sprint 47 Timing Capture Log
...
Triage artifact: `docs/ichart-sprint-47-confidence-performance-triage-2026-05-26.md`
...
- Xcode/device console log file: not captured; unified log search did not return `iChart chord` timing lines
- metadata source: CoreSimulator app data `Library/Application Support/iChart/chord-entry-diagnostics.jsonl`
- exported PDF result: `Library/Caches/iChartExports/untitled-chart-concert.pdf`, modified 2026-05-26 16:31:58Z, rendered visually in Preview and via `sips`
