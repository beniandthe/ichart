...
- The next likely Sprint 71 slice is save/reopen confidence or release hygiene, depending on whether the user wants more app-surface polish first.

Candidate Sprint 71 continuing order:

1. Save/reopen confidence: visible but quiet saved-state behavior.
2. Release hygiene: build settings, app metadata, stale-doc audit, PR/CI readiness.
3. Toolstrip/menu affordances: only targeted polish not covered by the user-side UI overhaul.
