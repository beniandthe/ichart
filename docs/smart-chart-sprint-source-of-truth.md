...
Status: not opened yet; candidate lane after Sprint 69 closeout.

Goal: turn the proven editor core into a clearer app experience. Start with project/library UX, export/share confidence, visible save/reopen confidence, and tool/menu affordance polish.
...
Candidate Sprint 70 starting order:
