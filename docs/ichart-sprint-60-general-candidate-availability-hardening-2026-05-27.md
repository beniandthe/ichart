# iChart Sprint 60 General Candidate Availability Hardening
...
- `swift test --scratch-path /tmp/iChartSwiftBuild-sprint60-availability --filter ChordInkRecognizerTests`
  - `41` tests executed
