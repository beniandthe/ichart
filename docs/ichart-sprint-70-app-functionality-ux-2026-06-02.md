# iChart Sprint 70 App Functionality And UX/UI
...
- Focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter 'ChartEditingTests|LeadSheetPageLayoutTests'`
- Result: `165` tests, `0` failures.
- Focused header SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter 'ChartEditingTests|LeadSheetPageLayoutTests|LeadSheetInteractionModeStatePolicyTests|FileChartRepositoryTests'`
- Result: `174` tests, `0` failures.
- Focused passive ink SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter 'LeadSheetInteractionModeStatePolicyTests|ChartEditingTests|LeadSheetPageLayoutTests|FileChartRepositoryTests'`
- Result: `174` tests, `0` failures.
- Full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `467` tests, `36` skipped, `0` failures.
- Chord/rhythm ink-session unification full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `467` tests, `36` skipped, `0` failures.
...
- User pen responsiveness full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `467` tests, `36` skipped, `0` failures.
- User pen responsiveness focused simulator: XcodeBuildMCP `test_sim -only-testing:iChartTests/LeadSheetInteractionModeStatePolicyTests CODE_SIGNING_ALLOWED=NO`
...
- Measure double barline focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter 'ChartEditingTests|LeadSheetPageLayoutTests'`
- Result: `172` tests, `0` failures.
- Measure double barline full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
...
- Chord tool correction full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `471` tests, `36` skipped, `0` failures.
- Chord tool correction focused simulator: XcodeBuildMCP `test_sim -only-testing:iChartTests/LeadSheetInteractionModeStatePolicyTests -only-testing:iChartTests/LeadSheetChordEditOverlayGeometryTests CODE_SIGNING_ALLOWED=NO`
...
- Chord tool rendered-box follow-up full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `471` tests, `36` skipped, `0` failures.
...
- Chord tool active-rendered-object follow-up full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `471` tests, `36` skipped, `0` failures.
...
- Editor back-swipe lock full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `471` tests, `36` skipped, `0` failures.
...
- `git diff --check` passed.
- Rhythm Section system-break focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter ChartEditingTests`
- Result: `100` tests, `0` failures.
- Rhythm Section system-break focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter LeadSheetPageLayoutTests`
- Result: `75` tests, `0` failures.
- Rhythm Section system-break full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
...
- Rhythm Section system visual alignment focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter LeadSheetPageLayoutTests`
- Result: `75` tests, `0` failures.
- Rhythm Section system visual alignment full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
- Result: `474` tests, `36` skipped, `0` failures.
...
- Rhythm Section standard measure widths focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter LeadSheetPageLayoutTests`
- Result: `76` tests, `0` failures.
- Rhythm Section standard measure widths full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
...
- Measure stack deletion focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter 'ChartEditingTests|LeadSheetPageLayoutTests'`
- Result: `177` tests, `0` failures.
- Measure stack deletion full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
...
- Controlled measure range deletion focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter ChartEditingTests`
- Result: `103` tests, `0` failures.
- Controlled measure range deletion full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
...
- Measure stack insertion focused SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile --filter ChartEditingTests`
- Result: `106` tests, `0` failures.
- Measure stack insertion full SwiftPM: `swift test --scratch-path /tmp/iChartSwiftBuild-layoutprofile`
