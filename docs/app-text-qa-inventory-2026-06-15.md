...
- [ ] Pending verification helper: "Open the verification link sent to {email} on this iPad."
...
- [ ] Actions: "Create Account", "Sign In", "Reset Password", "Send New Verification Email", "I Verified, Sign In", "Save Password", "Cancel", "Reconnect", "Refresh", "Sign Out"
- [ ] Store messages: "Account created. Check your email, then open the verification link on this iPad.", "Signed in.", "Signed out.", "Verification email sent. Open the newest link on this iPad.", "Password reset email sent.", "Email verified. You're signed in.", "Account session refreshed.", "Password updated. You're signed in.", "Profile updated."
