...
- [ ] Pending verification helper: "Waiting for {email}. Open the newest iChart email and tap Verify iChart Account."
...
- [ ] Pending verification steps: "This page will stay here until iChart confirms your email link.", "Open Mail on this iPad.", "Open the newest email from iChart.", "Tap Verify iChart Account.", "Tap Return to iChart on the browser page.", "Waiting for email verification...", "Do not use old iChart emails. If you send a new email, older links may stop working."
- [ ] Actions: "Create Account", "Sign In", "Reset Password", "Send One New Email", "Save Password", "Cancel", "Reconnect", "Refresh", "Sign Out"
- [ ] Store messages: "Email verification sent. Open Mail and tap Verify iChart Account in the newest iChart email.", "Signed in.", "Signed out.", "New email sent. Open Mail and tap Verify iChart Account in the newest iChart email.", "Password reset email sent.", "Verification complete.", "Account session refreshed.", "Password updated. You're signed in.", "Profile updated."
