...
- [ ] Account status labels: "Account unavailable", "Signed out", "Temporarily offline", "Email Verification Sent", "Set new password", "Verified", "Signed in"
...
- [ ] Pending verification helper: "Waiting for {email}. Open the iChart verification email and tap Verify iChart Account."
...
- [ ] Pending verification steps: "This page will stay here until iChart confirms your email link.", "Open Mail on this iPad.", "Find the iChart verification email.", "Tap Verify iChart Account.", "Tap Return to iChart on the browser page.", "Waiting for email verification...", "Do not tap anything else here after opening the email. iChart will move forward when the link is confirmed."
- [ ] Pending verification recovery: "Email Didn't Arrive?", "Use this only if no iChart email arrived after a few minutes. It sends one replacement email to the same address.", "Send Replacement Email", "Replacement Email Sent", "Open Mail and tap Verify iChart Account. If the replacement email still does not arrive, contact support."
- [ ] Actions: "Create Account", "Sign In", "Reset Password", "Email Didn't Arrive?", "Send Replacement Email", "Already Verified? Sign In", "Use a Different Email", "Save Password", "Cancel", "Reconnect", "Refresh", "Sign Out"
- [ ] Store messages: "Verification email sent. Open Mail and tap Verify iChart Account.", "Signed in.", "Signed out.", "Password reset email sent.", "Verification complete.", "Account session refreshed.", "Password updated. You're signed in.", "Profile updated."
- [ ] Error: "This link is not an iChart account verification link."
...
- [ ] Rhythm entry explainer: dedicated Rhythm tool retired for V1; use Free-Write for rhythm notation. V1.2 target: select-input rhythm notation.
