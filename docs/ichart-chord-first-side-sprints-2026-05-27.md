# iChart Chord-First Side Sprints
...
- Validate write -> recognize -> auto-render or confirm -> clear ink -> edit if needed -> export using `docs/ichart-sprint-62-chord-first-release-candidate-pass-2026-05-27.md`.
- Pass metadata committed `C`, `G/B`, `Db7(b9)`, and `Absus` with matched placement and small render handoff.
- Fresh PDF export evidence was verified in iChart's export cache and Preview; the rendered page included all four chords.
